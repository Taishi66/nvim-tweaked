...
function M.show_cheatsheet()
  ...
  local lines = {
    ...
    "  Ctrl+R          Fichiers recents",
    "  Ctrl+N          Nouveau fichier",
    "  Ctrl+S          Sauvegarder",
    "  Ctrl+Shift+S    Sauvegarder tout",
    "  <leader>w       Fermer buffer",
    "",
    "  RECHERCHE",
    "  ────────────────────────────────────────────────────────────────",
    "  Ctrl+F          Chercher dans fichier (fuzzy)",
    "  Ctrl+Shift+F    Chercher dans projet (grep)",
    "  /               Chercher dans fichier (natif vim)",
    "  <leader>ff      Chercher dans fichier (fuzzy picker)",
    "  <leader>fg      Chercher dans projet (grep)",
    "  <leader>sg      Grep (alternative LazyVim)",
    ...
    "  Shift+H/L       Buffer precedent/suivant (LazyVim)",
    "",
    "  EDITION",
    "  ────────────────────────────────────────────────────────────────",
    "  Ctrl+Z          Annuler",
    ...
    "  Ctrl+D          Selectionner occurrence suivante",
    "  Ctrl+Shift+D    Dupliquer ligne",
    "  Ctrl+/ ou gcc   Commenter/Decommenter",
    "  Alt+J/K         Deplacer ligne haut/bas (LazyVim)",
    "",
    "  LSP / CODE",
    "  ────────────────────────────────────────────────────────────────",
    "  F2              Renommer symbole",
    ...
    "  Ctrl+`          Terminal",
    "  Ctrl+/ ou Ctrl+_  Terminal (LazyVim)",
    "  Ctrl+K Z        Mode Zen",
    ...
    "  FENETRES (LazyVim)",
    "  ────────────────────────────────────────────────────────────────",
    "  Ctrl+H/J/K/L    Navigation entre fenetres",
